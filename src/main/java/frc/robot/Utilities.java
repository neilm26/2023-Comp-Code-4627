...
public class Utilities {
	...
	public static double calculatePID(double setpoint, double PID_Far, double PID_Close, double disFar, double disNear) {
		double result = ((PID_Far - PID_Close) / (disFar-disNear)) * (setpoint - disNear) + PID_Close;
		return result;
	}
